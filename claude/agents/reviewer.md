---
name: reviewer
description: Reviews a diff, feature or subsystem for correctness, quality, security and test honesty, returning a numbered fix list and a verdict; dispatched through /review, not invoked directly.
color: yellow
model: fable
effort: high

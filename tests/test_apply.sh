...
printf '%s\n' '{"hooks": {"PreToolUse": [{"matcher": "Bash", "script": "demo.py", "timeout": 10}]},' \
  ...
  '  "permissions.allow": ["Bash(git commit:*)", "Bash(rm:*)", "Bash(find:*)", "Bash(mv:*)"]}}' > "$FIX/claude/settings.json"
...
assert doc["permissions"] == {"allow": ["Bash(git commit:*)", "Bash(rm:*)", "Bash(find:*)", "Bash(mv:*)"]}
